...
import { FaBriefcase, FaPlus, FaTimes, FaSave } from 'react-icons/fa';
...
const CreateJobOffer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await jobService.createOffer(payload);
      if (result.success) {
        alert('Oferta creada. Pendiente de aprobación universitaria.');
  ...
  return (
    <div className="create-job">
      <SEO title="Crear Oferta Laboral" description="Publica una nueva oferta de práctica profesional o empleo" />

      <h1 className="create-job__title"><FaBriefcase /> Publicar Oferta</h1>
      <p className="create-job__subtitle">La oferta será revisada por la universidad antes de publicarse</p>
      ...
      <form className="create-job__form" onSubmit={handleSubmit}>
        ...
        <section className="create-job__section">
          ...
          <div className="create-job__field">
            ...
            <input id="title" name="title" value={form.title} onChange={handleChange}
              placeholder="Ej: Practicante de Ingeniería de Sistemas" maxLength={150} required />
          </div>

          <div className="create-job__field">
            <label htmlFor="description">Descripción *</label>
            <textarea id="description" name="description" value={form.description} onChange={handleChange}
              placeholder="Describe las responsabilidades, el equipo de trabajo, beneficios..." rows={6} maxLength={5000} required />
          </div>

          <div className="create-job__row">
            <div className="create-job__field">
              <label htmlFor="type">Tipo de vinculación *</label>
          ...
          {form.requirements.map((req, i) => (
            <div key={i} className="create-job__requirement-row">
              ...
              {form.requirements.length > 1 && (
                <button type="button" className="create-job__remove-btn" onClick={() => removeRequirement(i)}>
                  <FaTimes />
                </button>
              )}
            </div>
          ))}
          <button type="button" className="create-job__add-btn" onClick={addRequirement}>
        ...
        <section className="create-job__section">
          ...
          <p className="create-job__hint">Selecciona las facultades cuyos estudiantes pueden aplicar</p>
        ...
        <section className="create-job__section">
          ...
          <div className="create-job__row">
            ...
            {form.compensationType === 'remunerada' && (
              <div className="create-job__field">
                ...
                <input id="compensationAmount" name="compensationAmount" type="number" value={form.compensationAmount}
                  onChange={handleChange} placeholder="Ej: 1500000" min={0} />
              </div>
            )}
            <div className="create-job__field">
          ...
          <div className="create-job__row">
            <div className="create-job__field">
              ...
              <input id="durationValue" name="durationValue" type="number" value={form.durationValue}
                onChange={handleChange} placeholder="Ej: 6" min={0} />
            </div>
            <div className="create-job__field">
